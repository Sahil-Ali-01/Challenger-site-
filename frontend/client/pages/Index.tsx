...
export default function Index() {
  ...
  if (isNewUser && user && userStats) {
    return (
      <Layout>
        {/* New User Welcome */}
        <section className="py-14 lg:py-20 flex flex-col items-center text-center space-y-7 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center">
            <Button size="lg" className="px-7 h-10 text-sm font-semibold shadow-lg shadow-primary/20" asChild>
              <Link to="/quiz">Start Your First Challenge <Zap className="ml-2 w-4 h-4 fill-current" /></Link>
            </Button>
            <Button size="lg" variant="outline" className="px-7 h-10 text-sm font-semibold glass-button" asChild>
          ...
          <div className="pt-16 w-full max-w-2xl">
            <div className="glass-card p-6 rounded-2xl border-border/70 space-y-5">
              <h3 className="text-xl font-bold text-center">Your Starting Profile</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center space-y-2">
                  ...
                  <p className="text-xl font-bold">{userStats.elo_rating}</p>
                </div>
                <div className="text-center space-y-2">
                  <div className="flex justify-center mb-2">
                  ...
                  <p className="text-xl font-bold">{userStats.weekly_points}</p>
                </div>
                <div className="text-center space-y-2">
                  <div className="flex justify-center mb-2">
                  ...
                  <p className="text-xl font-bold">{userStats.accuracy.toFixed(0)}%</p>
                </div>
                <div className="text-center space-y-2">
                  <div className="flex justify-center mb-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {categories.map((cat) => (
              <Link 
                ...
                className="glass-card p-5 rounded-xl hover:scale-[1.01] transition-all duration-300 group cursor-pointer border-border/70 hover:border-primary/40"
              >
  ...
  if (isExperiencedUser && user && userStats) {
    return (
      <Layout>
        ...
        <section className="py-12 space-y-7">
          <div className="space-y-4">
            <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight">
              Welcome back, <span className="text-primary">{userStats.full_name?.split(' ')[0]}</span>! 👋
            </h1>
            <p className="text-base text-muted-foreground">You're on a roll! Keep solving to climb the leaderboard.</p>
          </div>

          {/* Quick Stats */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="glass-card p-5 rounded-xl border-border/70 space-y-3">
            ...
            <div className="glass-card p-5 rounded-xl border-border/70 space-y-3">
              ...
              <p className="text-2xl font-bold">{userStats.accuracy.toFixed(1)}%</p>
